                ...
                <tr>
                    ...
                    <td>
                        <a class="btn btn-info"
                           href="<?= url('manage_key_degree.php?action=view&id=' . $val['water_id']) ?>"><i
                                class="fa fa-eye" aria-hidden="true"></i></a>
                        <a class="btn btn-warning"
                           href="<?= url('manage_key_degree.php?action=edit&id=' . $val['water_id']) ?>"><i
                                class="fa fa-edit" aria-hidden="true"></i></a>
                        <a class="btn btn-danger" onclick="confirmDelete(this, event)"
                           href="<?= url('manage_key_degree.php?action=delete&id=' . $val['water_id']) ?>"><i
