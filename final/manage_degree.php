...
<head>
    ...
    <title><?=$txt['menu_admin']['sub_menu'][4]?> | <?=$txt['web_name'] ?></title>
...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        <div class="page-title">
            <div>
                <h1><i class="fa fa-dashboard"></i> <?=$txt['menu_admin']['sub_menu'][4]?> </h1>
            ...
            <div>
                <ul class="breadcrumb">
                    ...
                    <li><a href="<?=url('manage_degree.php') ?>"><?=$txt['menu_admin']['sub_menu'][4]?> </a></li>
                </ul>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="text-right">
                    <a class="btn btn-primary btn-lg" href="<?=url('manage_degree.php?action=create') ?>">เพิ่มข้อมูล</a>
                    <br>
                    <br>
                </div>
                ...
                if (isset($_GET['action'])) {
                    ...
                    if ($_GET['action'] == 'view') {
                        // id
                        include_once __DIR__ . '/process_page/manage_degree/view.php';
                    }
                    elseif ($_GET['action'] == 'create') {
                        include_once __DIR__ . '/process_page/manage_degree/create.php';
                    }
                    elseif ($_GET['action'] == 'insert') {
                        include_once __DIR__ . '/process_page/manage_degree/insert.php';
                    }
                    elseif ($_GET['action'] == 'edit') {
                        // id
                        include_once __DIR__ . '/process_page/manage_degree/edit.php';
                    }
                    elseif ($_GET['action'] == 'update') {
                        // id
                        include_once __DIR__ . '/process_page/manage_degree/update.php';
                    }
                    elseif ($_GET['action'] == 'delete') {
                        // id
                        include_once __DIR__ . '/process_page/manage_degree/delete.php';

                    } else {
                        echo '<script>window.location.href = "manage_degree.php"</script>';
                    }
                } else {
                    // show all
                    include_once __DIR__ . '/process_page/manage_degree/show-all.php';
                }
                ?>
            </div>
        </div>
